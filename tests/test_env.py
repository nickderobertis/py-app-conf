...
def test_override_from_env(model_classes: Tuple[Type[BaseConfig], Type[BaseConfig]]):
...
def test_override_from_dotenv(model_classes: Tuple[Type[BaseConfig], Type[BaseConfig]]):
    MyConfig, SubConfig = model_classes
    ENV_PATH.write_text(
        """
MYAPP_STRING=abc
